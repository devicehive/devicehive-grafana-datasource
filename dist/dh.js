...
System.register(['moment'], function (_export, _context) {
  ...
  var moment, _slicedToArray, _createClass, DeviceHiveClient;
  ...
  return {
    ...
    execute: function () {
                    ...
                    if (!path.includes('Orient')) {
                      ...
                      datas.forEach(function (data) {
                        if (typeof _this2.__extractValue(data, path) !== 'object') {
                          points.push([_this2.__extractValue(data, path) * scale, +moment.utc(data.timestamp).format('x')]);
                        }
                      });
      ...
      _export('default', DeviceHiveClient);
    }
  };
});
